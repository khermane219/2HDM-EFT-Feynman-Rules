# 2HDM-EFT-Feynman-Rules
FeynRules model package designed to calculate all Feynman rules in the general Two-Higgs Doublet Model Effective Field Theory (2HDM EFT) and its specific limits and types up-to-and including mass dimension six operators. 

Please refer to the following works for notation, conventions, and the operators spanned in the 2HDM EFT:
